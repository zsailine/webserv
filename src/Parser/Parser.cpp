...
/*   Updated: 2025/07/10 10:28:26 by zsailine         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
Parser::Parser(std::string data)
{
	...
	init_socket();
	addRoute();
	std::cout << server[0].check_url("/blan/") << std::endl;
	std::cout << server[0].check_url("/blan/man") << std::endl;
	std::cout << server[0].check_url("/bla") << std::endl;
}